...
let isBelowTarget: Bool = currentHR < targetLowerBound // ниже предела
let isAboveTarget: Bool = targetUpperBound < currentHR // выше пределов
let isInTarget:Bool = !isBelowTarget && !isAboveTarget
if isBelowTarget {
